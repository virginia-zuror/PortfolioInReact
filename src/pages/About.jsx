  ...
  return (
    <div className='about'>
      ...
      <div className='links-prof'>
        <a href='https://www.linkedin.com/in/virginia-zurita-ortiz/'><img src='https://res.cloudinary.com/do7bnejaz/image/upload/v1682438843/assets/linkedin_ai0syv.png' alt='LinkedIn'/></a>
        <a href='https://github.com/virginia-zuror/'><img src='https://res.cloudinary.com/do7bnejaz/image/upload/v1682438922/assets/github_fmllwl.png' alt='Git Hub'/></a>
        <a href='https://codepen.io/virginia-zuror'><img src='https://res.cloudinary.com/do7bnejaz/image/upload/v1682440349/assets/codepen-wordmark-black_vfohxy.png' alt='codepen logo'/></a>
      </div>
      </div>
      <div className='skills'>
        ...
        <abbr title="ReactJS">
          ...
          <abbr title='GitHub'><img src='https://res.cloudinary.com/do7bnejaz/image/upload/v1682438922/assets/github_fmllwl.png' alt='GitHub logo'/></abbr>
        </div>
